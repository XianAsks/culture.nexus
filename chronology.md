...
Every row carries one `#e/` tag from `tags.md` §3, unchanged. A traditional date is `#e/devotional`;
a radiocarbon date `#e/attested`; a date derived from a synchronism `#e/inferred`; a date under
active dispute `#e/contested`. This is what cross-linking to `tags.md` buys — the tag says how to
read the date, not how good it is (see `methods.md` §9.1).
...
index are `#e/unverified` regardless of how confident the source sounded.

| id | date | kind | entity | bears-on | tag | rung |
|---|---|---|---|---|---|---|
| buddha-life | [c. 480–c. 400 BCE] | ev | Life of Siddhārtha Gautama — dating heavily disputed | Q2, §14.8 | `#e/contested` | — |
| lalitavistara | [C1–C3 CE] | comp | *Lalitavistara Sūtra*, candidate source of the Barlaam chain | §14.8 | `#e/unverified` | — |
| bj-sanskrit | [C2–C4 CE] | comp | Sanskrit Mahāyāna source text of the Barlaam material | §14.8 | `#e/unverified` | 2 |
| bj-persian | [C6–C7 CE] | comp | Middle Persian *Bodisav* — the step the popular retelling drops | §14.8 | `#e/attested` | 1 |
| bj-arabic | C8 CE | comp | Arabic *Kitāb Bilawhar wa-Būd̠āsaf*, current in Baghdad | §14.8, H5 | `#e/attested` | 1 |
| bj-georgian | C10 CE | comp | Georgian *Balavariani* — first Christianised adaptation | §14.8 | `#e/attested` | 2 |
| euthymius | t.a.q. 1028 CE | comp | Greek *Barlaam and Ioasaph*, by Euthymius of Athos | §14.8 | `#e/attested` | 2 |
| bj-latin | 1048 CE | comp | Latin translation; the name enters Western Europe | §14.8 | `#e/attested` | 1 |
| bj-relic | 1571 CE | ev | Josaphat relic presented to King Sebastian of Portugal | §14.8, Q5 | `#e/unverified` | 4 |
| bj-refuted | [C19–C20 CE] | ev | Conybeare and Peeters establish the Georgian/Arabic descent | §14.8, §7.2 | `#e/attested` | — |
| kuntsevych | 1960 CE | ev | Josaphat Kuntsevych set at 16 Nov — *not* a removal of Barlaam/Josaphat | §14.8 | `#e/attested` | — |
| gandharan-art | [c. 100 BCE–c. 400 CE] | ev | Gandhāran sculptural production | Q8, H5, H7 | `#e/attested` | 4 |
| halo-gandhara | c. C1 CE | ev | Earliest nimbate Buddha images — H5's anchor | H5 | `#e/contested` | 4 |
| dunhuang-caves | [c. 366–c. 1000 CE] | ev | Mogao cave excavation and use | Q8a | `#e/attested` | 4 |
| dunhuang-sealed | c. 1000 CE | ev | Cave 17 sealed — the reason the archive survives | Q8a, §14.7 | `#e/contested` | 4 |
| dunhuang-opened | 1900 CE | ev | Wang Yuanlu opens Cave 17 | Q8a, §14.7 | `#e/attested` | — |
| nubchen | c. C10 CE | comp | Nubchen Sangye Yeshe, *bSam gtan mig sgron* | Q4 | `#e/attested` | 2 |
| terma-tradition | t.p.q. C11 CE | ev | Treasure revelation as an established Nyingma practice | H7, §14.5a | `#e/contested` | — |
| rainbow-body-doc | t.p.q. C11 CE | comp | Earliest datable rainbow-body doctrinal material | Q1, H2 | `#e/contested` | 2 |
| pema-dudul | 1872 CE | ev | Death of Nyagla Pema Dündul | Q1 | `#e/unverified` | — |
| khenpo-acho | 1998 CE | ev | Death of Khenpo A Chö — **1998 vs 1999 unresolved (C7)** | Q1 | `#e/contested` | — |
| norbu-talks | 1982 CE | ev | Norbu's California talks, as delivered | Q1, H4 | `#e/attested` | — |
| norbu-print | 1988 CE | ms | *Talks in California, USA 1982*, first printing Sept 1988 | Q1, H4 | `#e/attested` | — |
| tiso-book | 2016 CE | comp | Tiso, *Rainbow Body and Resurrection* | Q3, H2 | `#e/attested` | — |
| gutenberg | c. 1450 CE | ev | Movable type in Europe — §14.6's substrate change | §14.6 | `#e/attested` | 4 |
...
? **`halo-gandhara` is tagged `#e/contested` deliberately** — whether the earliest nimbate images
